  ...
  return (
    <div className="space-y-8 sm:space-y-12">
      ...
      <section aria-labelledby="popular-products-heading">
        <div className="flex justify-between items-center mb-4 sm:mb-6">
          <h2 id="popular-products-heading" className="font-headline text-2xl sm:text-3xl font-semibold text-foreground uppercase">Populares</h2>
        ...
        {featuredProducts.length > 0 ? (
          ...
          <p className="text-muted-foreground text-sm sm:text-base">Nenhum produto popular encontrado.</p>
        )}
      </section>
      ...
      <section aria-labelledby="featured-categories-heading">
        <div className="flex justify-between items-center mb-4 sm:mb-6">
          <h2 id="featured-categories-heading" className="font-headline text-2xl sm:text-3xl font-semibold text-foreground uppercase">Categorias em Destaque</h2>
        </div>
          ...
          <Link href="/products?category=GANHO%20DE%20MASSA" passHref>
            <div className="group relative aspect-[3/4] sm:aspect-video md:aspect-[3/4] overflow-hidden rounded-lg border border-border/40 hover:border-border/70 shadow-none transition-all duration-300 cursor-pointer">
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-end p-4 sm:p-6 text-center">
                <h3 className="font-headline text-2xl sm:text-3xl md:text-4xl font-bold text-primary uppercase shadow-md mb-2 sm:mb-3">GANHO DE MASSA</h3>
            ...
            <Link href="/products?category=ENDURANCE" passHref>
              <div className="group relative h-full w-full overflow-hidden rounded-lg border border-border/40 hover:border-border/70 shadow-none transition-all duration-300 cursor-pointer">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-end p-3 sm:p-4 text-center">
                  <h3 className="font-headline text-xl sm:text-2xl md:text-3xl font-bold text-primary uppercase shadow-md mb-1.5 sm:mb-2">ENDURANCE</h3>
            ...
            <div className="grid grid-cols-2 gap-3 sm:gap-4 md:gap-6 h-full">
              <Link href="/products?category=EMAGRECIMENTO" passHref>
                <div className="group relative h-full w-full overflow-hidden rounded-lg border border-border/40 hover:border-border/70 shadow-none transition-all duration-300 cursor-pointer">
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-end p-2 sm:p-3 text-center">
                    <h3 className="font-headline text-lg sm:text-xl md:text-2xl font-bold text-primary uppercase shadow-md mb-1 sm:mb-2">EMAGRECIMENTO</h3>
                    <Button variant="secondary" size="xs" className="bg-neutral-800/80 hover:bg-neutral-900/90 text-white px-2.5 sm:px-4 py-0.5 sm:py-1 text-[10px] sm:text-xs">Ver Agora</Button>
                  </div>
                </div>
              </Link>
              <Link href="/products?category=DEFINIÇÃO" passHref>
                <div className="group relative h-full w-full overflow-hidden rounded-lg border border-border/40 hover:border-border/70 shadow-none transition-all duration-300 cursor-pointer">
                  ...
                  <div className="absolute inset-0 flex flex-col items-center justify-end p-2 sm:p-3 text-center">
                    <h3 className="font-headline text-lg sm:text-xl md:text-2xl font-bold text-primary uppercase shadow-md mb-1 sm:mb-2">DEFINIÇÃO</h3>
                    <Button variant="secondary" size="xs" className="bg-neutral-800/80 hover:bg-neutral-900/90 text-white px-2.5 sm:px-4 py-0.5 sm:py-1 text-[10px] sm:text-xs">Ver Agora</Button>
                  </div>
                </div>
              </Link>
